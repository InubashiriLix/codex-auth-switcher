...
La configurazione è in `$XDG_CONFIG_HOME/codex-switcher/config.toml`; account e metadati sono in `$XDG_DATA_HOME/codex-switcher/`. Linux è attualmente la piattaforma verificata.
